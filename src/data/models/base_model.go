...
type BaseModel struct {
	...
	CreatedAt  time.Time    `gorm:"type:"TIMESTAMP" with zone;not null;"`
	ModifiedAt sql.NullTime `gorm:"type:"TIMESTAMP" with zone;null;"`
	DeletedAt  sql.NullTime `gorm:"type:"TIMESTAMP" with zone;null;"`
